...
def máxima (valor_1= int(input("insira o primeiro valor")),valor_2= int(input("insira o segundo valor")),
	...
	elif (valor_2 > valor_1) and (valor_2 > valor_3): #condição para verificar se o valor 3 é maior
		maior = valor_2
		print (maior) #imprimir o maior valor
	
	elif (valor_3 > valor_1) and (valor_3 > valor_2): #condição para verificar se o valor 3 é maior
		maior = valor_3
		print (maior) #imprimir o maior valor
